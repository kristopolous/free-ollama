...
* Dyva's architecture draws a hard line at incurring any *additional* costs. Obly unused time on idle machines to avoid, in spirit a [trespass to chattels](https://en.wikipedia.org/wiki/Trespass_to_chattels).
