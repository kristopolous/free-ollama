...
OpenAI and Ollama-compatible proxy that routes inference to insecure Ollama, vllm, LM Studio, SGLang, llama.cpp, ds4, A1111, and ComfyUI hosts using Shodan and FOFA.
